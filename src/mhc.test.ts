...
describe('MarkdownParser', () => {
    ...
    describe('Markdown to HTML conversion', () => {
        ...
        test('converts combined markdown elements in a sentence - without paragraphs', () => {
        ...
        test('converts combined markdown elements in a sentence - with paragraphs', () => {
            const markdown = "# Main Title\nThis is a **bold statement** with some *italic emphasis*.";
    ...
    describe('HTML to Markdown conversion', () => {
        ...
        test('converts combined HTML elements in a sentence', () => {
    ...
    describe('MarkdownParser Nesting', () => {
        test('handles nested formatting - without paragraphs', () => {
        ...
        test('handles nested formatting - with paragraphs', () => {
            const markdown = "This is **bold with *italic* inside**";
        ...
        test('handles multiple levels of nesting - with paragraphs', () => {
    ...
    describe('MarkdownParser Line Breaks and Paragraphs', () => {
        test('handles single line breaks', () => {
